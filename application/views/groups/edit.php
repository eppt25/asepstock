        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">แก้ไขสิทธิ</h3>
            </div>
            <form role="form" action="<?php base_url('groups/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="ใส่ชื่อสิทธิ" value="<?php echo $group_data['group_name']; ?>">
                </div>
                <div class="form-group">
