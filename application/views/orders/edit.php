      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">แก้ไขคำสั่งซื้อ</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">ชื่อลูกค้า</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="ใส่ชื่อลูกค้า" value="<?php echo $order_data['order']['customer_name'] ?>" autocomplete="off"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="ใส่ที่อยู่" value="<?php echo $order_data['order']['customer_address'] ?>" autocomplete="off">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">เบอร์โทรลูกค้า</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="ใส่เบอร์โทรลูกค้า" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                    <tr>
                      ...
                      <th style="width:20%">ราคารวมทุกชิ้น</th>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">ราคารวมสินค้าทั้งหมด</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="service_charge" class="col-sm-5 control-label">ค่าบริการ <?php echo $company_data['service_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">ภาษีมูลค่าเพิ่ม <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="ส่วนลด" onkeyup="subAmount()" value="<?php echo $order_data['order']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">ราคาทั้งหมดที่ต้องจ่าย</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">สถานะการจ่ายเงิน</label>
                    <div class="col-sm-7">
                      <select type="text" class="form-control" id="paid_status" name="paid_status">
                        <option value="1">จ่ายแล้ว</option>
                        <option value="2">ยังไม่จ่าย</option>
                      </select>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >พิมพ์</a>
                <button type="submit" class="btn btn-primary">บันทึก</button>
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">ย้อนกลับ</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
