    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">เพิ่มข้อมูลแบรนด์</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">จัดการข้อมูลแบรนด์</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">เพิ่มข้อมูลแบรนด์</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('brands/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="ใส่ชื่อแบรนด์" autocomplete="off">
          </div>
          <div class="form-group">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editBrandModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">แก้ไขข้อมูลแบรนด์</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('brands/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">ชื่อแบรนด์</label>
            <input type="text" class="form-control" id="edit_brand_name" name="แก้ไขชื่อแบรนด์" placeholder="Enter brand name" autocomplete="off">
          </div>
          <div class="form-group">
